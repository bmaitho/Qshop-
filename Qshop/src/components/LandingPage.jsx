...
const LandingPage = ({ setToken }) => {
  ...
  if (isLogin) {
    // Login: Keep slideshow - REMOVED overflow-y-auto from inner container
    return (
      <div className="flex flex-col h-screen w-full overflow-hidden">
        ...
        <div className="w-full h-3/5 p-4 flex flex-col bg-[#0e1a19] text-white">
          <div className="max-w-md mx-auto w-full">
            <div className="text-center mb-6">
              <h1 className="text-3xl font-bold text-[#e7c65f]">UniHive</h1>
              <p className="text-gray-400 mt-2">Student Marketplace</p>
    ...
    // SignUp: Completely different structure - full page scroll, no containers
    return (
      <div className="min-h-screen bg-[#0e1a19] text-white">
        ...
        <div className="max-w-md mx-auto p-4">
          ...
          {/* Authentication Component - Full content flow */}
          <AuthForms 
            isLogin={isLogin} 
            toggleAuthMode={toggleAuthMode}
            setToken={setToken}
